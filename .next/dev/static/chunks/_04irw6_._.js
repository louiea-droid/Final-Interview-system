...
function AdminPage() {
    ...
    async function loadCandidates() {
        setLoading(true);
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('candidates').select('*').order('sort_order', {
            ascending: true
        }).order('created_at', {
            ascending: true
        });
    ...
    async function addCandidate(e) {
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('candidates').insert({
            ...form,
    ...
    async function updateStatus(id, status) {
        setMessage('');
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('candidates').update({
            status
        }).eq('id', id);
        if (error) {
            setMessage(error.message);
    ...
    async function removeCandidate(id) {
        ...
        if (!confirmed) return;
        setMessage('');
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('candidates').delete().eq('id', id);
        if (error) {
            setMessage(error.message);
            return;
        }
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminPage.useMemo[stats]": ()=>{
            ...
            const scheduled = candidates.filter({
                "AdminPage.useMemo[stats]": (c)=>c.status === 'Scheduled' || c.status === 'Waiting' || c.status === 'In Progress'
            }["AdminPage.useMemo[stats]"]).length;
            const completed = candidates.filter({
                "AdminPage.useMemo[stats]": (c)=>c.status === 'Completed'
            }["AdminPage.useMemo[stats]"]).length;
            return {
                total,
                scheduled,
                                ...
                                children: loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                            children: [
                                                candidates.map((candidate)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                        children: [
                                                ...
                                                !candidates.length && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
...
_s(AdminPage, "moSnv9y4FkKKqUFEgn53WPOE7n0=");
_c = AdminPage;
...
//# sourceMappingURL=_04irw6_._.js.map